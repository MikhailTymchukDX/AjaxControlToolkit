...
Sys.Extended.UI.ModalPopupBehavior.prototype = {
    ...
    _createDomElements: function() {
        ...
        this._backgroundElement.setAttribute(this._zOrdering.getOrderableElementAttributeName(), 'modalPopupBackground');
    ...
    _setZIndex: function() {
        ...
        this._backgroundElement.style.zIndex = this._zOrdering.getTopZIndex(Sys.Extended.UI.zIndex.ModalPopupBackground);
